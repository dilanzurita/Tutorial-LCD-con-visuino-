 ...
 //------------------ Source --------------------
 //
 // Ejemplo LCD 16x2 sin compilar.visuino
 //
 //----------------------------------------------
...
{
public:
    inline static constexpr const char *GetValue() { return "HOLA DILAN"; }
};

class TextValue1
{
public:
    inline static constexpr const char *GetValue() { return "LO LOGRASTE "; }
};
...
Mitov::LiquidCrystalDisplay<
  ...
  Mitov::DigitalPin_DirectBoardPinImplementation<1 >, // 1_PINS_0
  Mitov::DigitalPin_NoImplementation<1 >, // 1_PINS_1
  Mitov::DigitalPin_DirectBoardPinImplementation<2 >, // 1_PINS_2
